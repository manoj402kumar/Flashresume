              ...
              {editMode && (
                ...
                >
                  ...
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="soothing-light-theme text-on-background bg-surface-container-lowest rounded-[2rem] p-6 shadow-md border border-primary/10"
                        ...
                        return (
                          <div key={sectionId} className="relative">
                            ...
                            <div
                              ...
                              className={`flex items-center gap-4 px-4 py-3 rounded-xl cursor-grab active:cursor-grabbing transition-all duration-150 shadow-sm select-none mb-1.5 ${isDragging
                            ...
                            >
                              <GripVertical className="text-on-surface-variant/40 w-5 h-5 flex-shrink-0" />
                  ...
                  {editMode && (
                    <div className="flex justify-center mt-6">
                      <button
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-primary/10 text-primary font-bold rounded-2xl hover:bg-primary/20 transition-all shadow-sm"
                        type="button"
                      >
