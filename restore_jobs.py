...
lines = [
    ...
    "                yield {\"event\": \"error\", \"data\": json.dumps({\"error\": \"Not authorized to view this job\"})}",
    "                return",
    "                ",
    ...
    "                        yield {\"event\": \"result\", \"data\": res_str}",
    "                    else:",
    "                        yield {\"event\": \"error\", \"data\": json.dumps({\"error\": \"Job completed but result payload is missing.\"})}",
    ...
    "                    ",
    "                    yield {\"event\": \"status\", \"data\": json.dumps({\"status\": status, \"error\": error})}",
    "                    ",
    "                    if status == \"COMPLETE\":",
    "                        job = await queue_manager.get_job(job_id)",
    ...
    "                        break",
    "                    elif status == \"FAILED\":",
    "                        yield {\"event\": \"error\", \"data\": json.dumps({\"error\": error or \"Job failed during processing.\"})}",
    "                        await asyncio.sleep(0.5)",
    "                        break",
    "                else:",
